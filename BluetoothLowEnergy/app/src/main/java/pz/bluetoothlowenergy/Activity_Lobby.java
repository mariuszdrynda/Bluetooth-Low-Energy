...
public class Activity_Lobby extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvNewDevices.setOnItemClickListener(Activity_Lobby.this);
...
//***remember the conncction will fail and app will crash if you haven't paired first
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
            ...
            mBluetoothConnection = new BluetoothConnectionService(Activity_Lobby.this);
